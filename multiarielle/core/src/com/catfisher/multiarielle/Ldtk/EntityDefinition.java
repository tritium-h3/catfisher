...
public class EntityDefinition {
    ...
    @lombok.Getter(onMethod_ = {@JsonProperty("nineSliceBorders")})
    @lombok.Setter(onMethod_ = {@JsonProperty("nineSliceBorders")})
    ...
    private Long tileID;
    @lombok.Getter(onMethod_ = {@JsonProperty("tileOpacity")})
    @lombok.Setter(onMethod_ = {@JsonProperty("tileOpacity")})
    private double tileOpacity;
    @lombok.Getter(onMethod_ = {@JsonProperty("tileRect")})
    @lombok.Setter(onMethod_ = {@JsonProperty("tileRect")})
