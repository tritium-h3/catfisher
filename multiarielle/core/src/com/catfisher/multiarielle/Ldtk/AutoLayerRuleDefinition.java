...
public class AutoLayerRuleDefinition {
    ...
    @lombok.Getter(onMethod_ = {@JsonProperty("xOffset")})
    @lombok.Setter(onMethod_ = {@JsonProperty("xOffset")})
    private long xOffset;
    @lombok.Getter(onMethod_ = {@JsonProperty("yModulo")})
    @lombok.Setter(onMethod_ = {@JsonProperty("yModulo")})
    private long yModulo;
    @lombok.Getter(onMethod_ = {@JsonProperty("yOffset")})
    @lombok.Setter(onMethod_ = {@JsonProperty("yOffset")})
